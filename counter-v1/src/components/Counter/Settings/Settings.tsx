...
export const Settings = (props: SettingsPropsType) => {
    const {START_COUNT, MAX_COUNT, changeStartCount, changeMaxCount, addNewSettings, status} = props;
    ...
    const disabled =
        status !== 'settings' || START_COUNT === MAX_COUNT || START_COUNT < 0 || MAX_COUNT < 0 || START_COUNT > MAX_COUNT;
